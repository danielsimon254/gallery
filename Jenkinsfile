    ...
    post {
        success {
            ...
            slackSend(
                ...
                message: """Deployment Successful! LINK: https://danielsimon-app-8acad26fbb55.herokuapp.com/ 🎉
Build ID: ${env.BUILD_ID}
Deployed App URL: ${APP_URL}""",
                color: 'good'
            )
        }
        failure {
            ...
            slackSend(
                channel: "${SLACK_CHANNEL}",
                message: """Deployment Failed...LINK: https://danielsimon-app-8acad26fbb55.herokuapp.com/ ❌
Build ID: ${env.BUILD_ID}
